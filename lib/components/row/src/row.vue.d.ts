...
declare const _default: import("vue").DefineComponent<{
    ...
    readonly justify: import("../../../utils").EpPropFinalized<StringConstructor, "start" | "end" | "space-around" | "space-between" | "space-evenly" | "center", unknown, "start", boolean>;
    readonly align: {
    ...
    readonly justify: import("../../../utils").EpPropMergeType<StringConstructor, "start" | "end" | "space-around" | "space-between" | "space-evenly" | "center", unknown>;
    readonly tag: string;
