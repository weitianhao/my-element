export declare const ElRow: import("element-plus/es/utils").SFCWithInstall<import("vue").DefineComponent<{
    ...
    readonly justify: import("element-plus/es/utils").EpPropFinalized<StringConstructor, "start" | "end" | "space-around" | "space-between" | "space-evenly" | "center", unknown, "start", boolean>;
    readonly align: {
    ...
    readonly justify: import("element-plus/es/utils").EpPropMergeType<StringConstructor, "start" | "end" | "space-around" | "space-between" | "space-evenly" | "center", unknown>;
    readonly tag: string;
