...
import { CloseBold, ArrowDown, Check } from '@element-plus/icons-vue';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose, emit }) {
    ...
    const currentPlaceholder = computed(() => searchInputValue.value || presentTags.value.length > 0 || isOnComposition.value ? "" : isFocus.value ? inputPlaceholder.value : "");
